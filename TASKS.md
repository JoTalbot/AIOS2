...
|---|---|---:|---|---|
| B27-01 | Audit journal sequence recovery after malformed/interleaved records | P0 | B26-01 | REVIEW |
| B27-02 | Add concurrent append/read stress regression coverage | P0 | B26-01 | READY |
| B27-03 | Audit audit-log durability and locking | P0 | None | DONE |
| B27-04 | Audit execution-store atomic rewrite/fsync semantics | P0 | None | DONE |
...
- Audit-log reads now share the existing process/file lock with writers.
- Atomic execution-store replacement now fsyncs the parent directory after rename on POSIX systems.
- Added regression coverage for both durability boundaries.
